  ...
  return (
    <div className="pt-5 pb-5" style={{ background: "linear-gradient(to right, #12394a, #044561)",height:"auto"}}>
      ...
      <div>
        ...
        {cart?.map((item) => {
          return (
            <div className="d-flex justify-content-evenly align-items-center ms-lg-3 ms-0 shadow mt-2 col-lg-10 col-12 text-light">
        ...
        <div className="col-lg-9 col-12 d-flex justify-content-end align-items-end flex-column mt-5 text-light ">
          <div className="d-flex justify-content-between col-lg-4 col-10 ">
